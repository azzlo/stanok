...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { email: @contributor.email, name: @contributor.name, phone: @contributor.phone, skills: @contributor.skills } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { email: @contributor.email, name: @contributor.name, phone: @contributor.phone, skills: @contributor.skills } }
