...
class ServiceChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_charge" do
    assert_difference('ServiceCharge.count') do
      post service_charges_url, params: { service_charge: { amount: @service_charge.amount, description: @service_charge.description, service_id: @service_charge.service_id } }
    end
  ...
  test "should update service_charge" do
    patch service_charge_url(@service_charge), params: { service_charge: { amount: @service_charge.amount, description: @service_charge.description, service_id: @service_charge.service_id } }
