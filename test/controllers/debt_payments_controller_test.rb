...
class DebtPaymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debt_payment" do
    assert_difference('DebtPayment.count') do
      post debt_payments_url, params: { debt_payment: { amount: @debt_payment.amount, description: @debt_payment.description, financial_expense_id: @debt_payment.financial_expense_id } }
    end
  ...
  test "should update debt_payment" do
    patch debt_payment_url(@debt_payment), params: { debt_payment: { amount: @debt_payment.amount, description: @debt_payment.description, financial_expense_id: @debt_payment.financial_expense_id } }
